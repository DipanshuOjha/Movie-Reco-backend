...
const CSV_PATH = path.join(__dirname, '../amazon_prime_titles.csv');
  ...
  return new Promise((resolve, reject) => {
    fs.createReadStream(CSV_PATH)
      ...
      .on('end', async () => {
        ...
        console.log(`Amazon Prime import complete! Movies added: ${count}, Skipped: ${skipped}`);
        resolve();
      })
      .on('error', (err) => {
...
main().catch((e) => {
  console.error('Error importing Amazon Prime movies:', e);
  process.exit(1);
}); 