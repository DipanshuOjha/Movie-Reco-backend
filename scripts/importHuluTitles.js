...
const CSV_PATH = path.join(__dirname, '../hulu_titles.csv');
  ...
  return new Promise((resolve, reject) => {
    fs.createReadStream(CSV_PATH)
      ...
      .on('end', async () => {
        ...
        console.log(`Hulu import complete! Movies added: ${count}, Skipped: ${skipped}`);
        resolve();
      })
      .on('error', (err) => {
...
main().catch((e) => {
  console.error('Error importing Hulu movies:', e);
  process.exit(1);
}); 