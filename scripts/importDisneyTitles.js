...
const CSV_PATH = path.join(__dirname, '../disney_plus_titles.csv');
  ...
  return new Promise((resolve, reject) => {
    fs.createReadStream(CSV_PATH)
      ...
      .on('end', async () => {
        ...
        console.log(`Disney import complete! Movies added: ${count}, Skipped: ${skipped}`);
        resolve();
      })
      .on('error', (err) => {
...
main().catch((e) => {
  console.error('Error importing Disney movies:', e);
  process.exit(1);
}); 